...
> 這一節是動手做的主場（約 70 分鐘）：把 Segment 1–3 學到的概念，在你自己的電腦（或 Colab，零安裝）上跑起來。
>
> 你會**親手實作** mini-project、完成 L1，看到 agent 真的回答你自己塞進去的資料 —— 不是看 demo，是你自己跑。
...
| 時段 | 做什麼 | 產出 |
|------|--------|------|
| 0–10 min | 看一次 demo + 自己跑 `setup.sh` | 5/5 ✅ |
...
> 卡住很正常——大部分時間就是邊跑邊除錯。卡住直接舉手或看下方「常見卡點」。
